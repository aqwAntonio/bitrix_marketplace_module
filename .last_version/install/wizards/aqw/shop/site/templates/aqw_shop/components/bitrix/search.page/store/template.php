...
<?else:?>
	<input type="text" lass="input-medium search-query" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
...
<?elseif(count($arResult["SEARCH"])>0):?>
	<?if($arParams["DISPLAY_TOP_PAGER"] != "N") echo '<br clear="all" />' . $arResult["NAV_STRING"]?>
    <br clear="all" />
